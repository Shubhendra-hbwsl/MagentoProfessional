    ...
    ) 
    {
        if ($this->config->isModuleEnabled()) {
            ...
            if ($results['valid'] == true) {
                ...
                // This line was causing error because this created null field for second street address
                // and PDO won't take null strings when serializing array objects.
                ...
                try{
                    ...
                    throw new Exception("Unable to set the address");
                } 

            } else {
                $mess = "Executing else block";

                throw new InputException($results['message']);
            }
        }
        $tempResult = $proceed($address);        
        return $tempResult;
    }
